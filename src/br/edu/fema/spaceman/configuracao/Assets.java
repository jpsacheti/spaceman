...
public class Assets {
	...
	public final static String PLAY = "play.png"; // Botão play
	public final static String HIGHSCORE = "highscore.png"; // Highscores
	public final static String HELP = "help.png"; // Ajuda
