...
public class MenuBotoes extends CCLayer implements ButtonDelegate {
	...
	public void buttonClicked(Botao sender) {
		...
		} else if (sender.equals(this.ajuda)) {
			System.out.println("Botão ajuda pressionado");
		} else if (sender.equals(this.recordes)) {
			System.out.println("Botão recordes pressionado");
		} else if (sender.equals(this.som)) {
			System.out.println("Botão som pressionado");
		}
